...
class PathPlanningDrawer:
    ...
    def draw_depot(self, depot):
        ...
        stddraw.filledPolygon(
            [coords[0] - (size_depot / 2), coords[0], coords[0] + (size_depot / 2)],
    ...
    def __draw_communication_range(self, body):
        ...
        stddraw.circle(body.coords[0], body.coords[1], body.communication_range)
        stddraw.setPenColor(c=stddraw.BLACK)
    ...
    def draw_blocks(self, drone_coo, target, size_cell, cells):
        ...
        for coord in cells:
            ...
            stddraw.filledRectangle(
                coord[0] * size_cell, coord[1] * size_cell, size_cell, size_cell
            )
            self.__reset_pen()
    ...
    def draw_simulation_info(self, cur_step, max_steps):
        ...
        TEXT_TOP = 20
        stddraw.text(
            TEXT_LEFT + 20, self.height - TEXT_TOP, str(cur_step) + "/" + str(max_steps)
        )
        self.__reset_pen()
