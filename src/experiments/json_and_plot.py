...
def plot_ndrones(
    ...
    for alg_k in alg_ritrasmission:
        ...
        for nd in n_drones:
            data_alg_k.append(
                mean_std_of_metric(filename_format, nd, alg_k, seeds, metric)
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        dest="alg_exp_suffix",
        action="append",
        default=["RND", "GEO", "QMR", "Q_FANET", "Q_FANET_OUR"],
        type=list,
    ...
    for metric in METRICS_OF_INTEREST:
        plot_ndrones(
            pattern_file, n_drones, metric, alg_exp_suffix, n_seeds, out_dir, "ndrones"
        )
